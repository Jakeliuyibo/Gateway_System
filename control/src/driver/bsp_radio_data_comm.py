...
class mRadioDataCommBase(object):
...
'''
description: 实现了数传通信驱动
'''
class mRadioDataCommDevice(mRadioDataCommBase):
    """ init device   """
    ...
    def __repr__(self):
        return '数传通信设备(接口%r:%r 状态%r)' % (self.local_ip, self.local_port, self.is_open)
